...
class UserInfoForm(forms.ModelForm):
    phone =forms.CharField(label="Phone Number:",widget=forms.TextInput(attrs={'class':'form-control','placeholder': 'Phone Number', 'class': 'form-control'}))
    district = forms.CharField(label="District:", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'District'}),required=False)
